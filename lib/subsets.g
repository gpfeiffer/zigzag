...
#############################################################################
##
#F  IsLeftDescent( <W>, <w>, <s> ) . . . . . . . . . . . . . . . . . descent.
##
##  How to test whether sw < w.
##
##  <#GAPDoc Label="IsLeftDescent">
##  <ManSection>
...
##  </Returns>
##  <Description>
##    The simple reflection <M>s \in S</M> is a <E>left
##    descent</E><Index>left descent</Index> of the element <M>w \in W</M> if
##    <M>\ell(sw) &lt; \ell(w)</M>.
##  <Example>
##  gap> W:= CoxeterGroup("A", 5);;
##  gap> w:= PermCoxeterWord(W, [2, 1, 3, 2, 1, 4, 3, 2, 1, 5, 4, 3]);;
##  gap> Filtered([1..5], s-> IsLeftDescent(W, w, s));
##  [ 2, 3, 4 ]
##  </Example>
##  </Description>
##  </ManSection>
...
IsLeftDescent:= function(W, w, s)
    return s^w > W.parentN;
end;

#############################################################################
##
#F  IsRightDescent( <W>, <w>, <s> ) . . . . . . . . . . . . . . . . . descent.
##
##  How to test whether ws < w.
##
##  <#GAPDoc Label="IsRightDescent">
##  <ManSection>
...
##  </Returns>
##  <Description>
##    The simple reflection <M>s \in S</M> is a <E>right
##    descent</E><Index>right descent</Index> of the element <M>w \in W</M> if
##    <M>\ell(ws) &lt; \ell(w)</M>.
##  <Example>
##  gap> W:= CoxeterGroup("A", 5);;
##  gap> w:= PermCoxeterWord(W, [2, 1, 3, 2, 1, 4, 3, 2, 1, 5, 4, 3]);;
##  gap> Filtered([1..5], s-> IsRightDescent(W, w, s));
##  [ 1, 3, 4 ]
##  </Example>
##  </Description>
##  </ManSection>
...
#############################################################################
##
#F  LongestElement( <W>, <J> ) . . . . . . . . . . . . . . . longest element.
##
##  <#GAPDoc Label="LongestElement">
##  <ManSection>
##  <Func Name="LongestElement" Arg="W, J"/>
##  <Returns>
##    the longest element of the parabolic subgroup of <A>W</A> generated by
##    the subset <A>J</A> of the simple reflections.
##  </Returns>
##  <Description>
##    A finite Coxeter group <M>W</M> has a unique longest element <M>w_0</M>
